...
const DEFAULT_GROQ_KEY = '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';
...
async function handleAIGenerate() {
  ...
  try {
    ...
    if (friendlyMsg.includes('rate limit') || friendlyMsg.includes('429')) {
      ...
      friendlyMsg = 'AI generator is temporarily unavailable. Please try again later.';
...
function setupAIGeneratorEvents() {
  ...
  document.getElementById('aiHeroOpenBtn')?.addEventListener('click', openAIGenerator);
      ...
      <div class="modal modal-xl" style="max-width:860px">
        <div class="modal-head">
          <div>
            ...
            <p class="modal-sub">Paste any text — get study-ready cards in seconds.</p>
          </div>
...
Ctrl+Enter to generate"></textarea>
        ...
        <div class="modal-foot" style="justify-content:space-between;align-items:center">
          <div style="font-size:0.72rem;color:var(--ink3)">
            Cards stay on your device. Text is sent only to generate cards.
          </div>
  ...
  // ── 2. Settings card REMOVED — AI now lives in its own dedicated section ──
  // (User feedback: keep settings focused; AI section already has its own page.)
